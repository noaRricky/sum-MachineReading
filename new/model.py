...
class MwAN(nn.Module):
    def __init__(self, vocab_size, embedding_size, encoder_size, drop_out=0.2):
        ...
        self.gru_agg = nn.GRU(12 * encoder_size, encoder_size,
        ...
        self.prediction = nn.Linear(
            2 * encoder_size, embedding_size, bias=False)
        self.initiation()
    ...
    def forward(self, inputs):
        ...
        a_score = torch.softmax(self.a_attention(a_embedding), 1)
